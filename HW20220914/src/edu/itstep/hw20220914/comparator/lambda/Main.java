package edu.itstep.hw20220914.comparator.lambda;
...
public class Main {
    ...
    public static void testUser() {
        ...
        System.out.println("- При сортування використовується посилання на лямбда-функцію");
        System.out.println();
        Collections.sort(users, (o1, o2) -> (o1.getFirstName() + o1.getLastName()).compareTo(o2.getFirstName() + o2.getLastName()));
        showUsers(users);
        ...
        System.out.println("- При сортування використовується посилання на лямбда-функцію");
        System.out.println();
        Collections.sort(users, (o1, o2) -> (o2.getFirstName() + o2.getLastName()).compareTo(o1.getFirstName() + o1.getLastName()));
        showUsers(users);
        ...
        System.out.println("- При сортування використовується посилання на лямбда-функцію");
        System.out.println();
        Collections.sort(users, (o1, o2) -> o2.getAddress().getCity().compareTo(o1.getAddress().getCity()));
        showUsers(users);
